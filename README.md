...
Учебный проект (модуль 5). Для продакшена стоит вынести секреты в безопасное хранилище и при необходимости донастроить разбиение документов и параметры поиска (top_k, chunk_size и т.д.).
